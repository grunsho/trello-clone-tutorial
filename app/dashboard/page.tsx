    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <main className='container mx-auto px-4 py-6 sm:py-8'>
        <div className='mb-6 sm:mb-8'>
          <h1 className='text-2xl sm:text3xl font-bold text-gray-900 mb-2'>
            Welcome back,{' '}
          ...
          <Card>
            <CardContent className='p-4 sm:p-6'>
              <div className='flex items-center justify-between'>
                ...
                <div className='h-10 w-10 sm:w-12 bg-purple-100 rounded-lg flex items-center justify-center'>
                  📊
                </div>
              </div>
            </CardContent>
        ...
        <div className='mb-6 sm:mb-8'>
          ...
          {boards.length === 0 ? (
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6'>
              ...
              <Card className='border-2 border-dashed border-gray-300 hover:border-blue-400 transition-color cursor:pointer group'>
            ...
            <div>
              ...
              {/* Create New Board */}
              <Card className='mt-4 border-2 border-dashed border-gray-300 hover:border-blue-400 transition-color cursor:pointer group'>
                <CardContent className='p-4 sm:p-6 flex flex-col items-center justify-center h-full min-h-[200px]'>
                  <Plus className='h-6 w-6 sm:h-8 sm:w-8 text-gray-400 group-hover:text-blue-600 mb-2' />
                  <p className='text-sm sm:text-base text-gray-600 group-hover:text-blue-600 font-medium'>
                    Create new board
      ...
      <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
        <DialogContent className='w-[95vw] max-w-425 mx-auto'>
          <DialogHeader>
